...
typedef enum { INS_ADD_POLICY = 201, INS_DELETE_POLICY, INS_FIND_POLICY, INS_LIST_POLICIES, INS_ADD_CLAIM, INS_LIST_CLAIMS, INS_REVIEW_CLAIM, INS_SETTLE_CLAIM, INS_PREV, INS_NEXT, INS_BACK } InsuranceAction;
